...
import jstack.eu.PoC.exception.InvalidExcelFileException;
import jstack.eu.PoC.exception.InvalidObjectFieldNameException;
...
public class ExcelToObjectMapper {
    ...
    public <T> ArrayList<T> map(Class<T> cls, int sheetId) throws Exception {
        ...
        for (int i=1; i<=lastRow;i++) {
            ...
            for (Field field: fields) {
                ...
                int index = getHeaderIndex(fieldName, workbook, sheetId);
     ...
     */
    private int getHeaderIndex(String headerName, Workbook workbook, int sheetId) throws Exception {
        Sheet sheet = workbook.getSheetAt(sheetId);
